...
<div class="ap-not-found ap-forum-empty ap-forum-empty--cannot_view" role="status">
    <h1 class="ap-archive-title"><?php echo function_exists('agora_esc') ? agora_esc($cannotViewMessage) : htmlspecialchars($cannotViewMessage, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?></h1>
