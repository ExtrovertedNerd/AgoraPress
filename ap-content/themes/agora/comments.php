...
/**
 * Comments list and Leave-a-comment form.
 *
 * Loaded by {@see ap_comments_template()} from single.php. Core does not
 * auto-append this after {@see ap_the_content()}.
 *
 * @package Agora
 */
...
if ($postId < 1 || !class_exists('AP_Comment', false)) {
    return;
}
