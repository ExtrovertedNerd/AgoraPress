...
class AP_Admin
{
    ...
    public static function menuItems(string $current = '', ?AP_DB $db = null): array
    {
        $items = [
            ...
            [
                'id' => 'options-mail',
                'label' => 'Mail',
                'url' => self::url('options-mail.php'),
                'active' => $current === 'options-mail',
                'cap' => 'manage_options',
                'module' => '',
                'section' => 'settings',
            ],
    ...
    public static function consumeQueryNotice(): void
    {
        ...
        $map = [
            ...
            'mail_test_sent' => ['Test email sent to the administration email address.', 'success'],
            ...
            'topic_moved' => ['Topic moved.', 'success'],
            'topics_merged' => ['Topics merged.', 'success'],
            ...
            'bulk_topic_moved' => ['Selected topics moved.', 'success'],
            'bulk_topic_merged' => ['Selected topics merged.', 'success'],
