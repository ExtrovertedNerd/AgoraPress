...
Older AgoraPress releases, kept so the living [CHANGELOG.md](CHANGELOG.md) stays short.

Format: [Keep a Changelog](https://keepachangelog.com/en/1.1.0/).
Versioning: [Semantic Versioning](https://semver.org/spec/v2.0.0.html).

This file covers **0.3.8-beta** through **0.2.0-beta**. Current work lives in `CHANGELOG.md`.
