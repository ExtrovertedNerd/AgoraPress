...
def test_phpunit_worker_cases_exist() -> None:
    ...
    for needle in (
        ...
        "function testWorkerDropsRevokedViewForumPermission",
        "function testSiteOffWorkerDoesNotSend",
        "function testUserOffWorkerDoesNotSend",
        "function testPosterExcludedFromWorkerMail",
        ...
        "function testWorkerLeavesRateLimitMailAlone",
        ...
        "mailRateLimitSnapshot",
        "PERM_VIEW",
        "function testInvalidAndExpiredTokensDoNotUnsubscribe",
        "function testFailedSendDoesNotDeleteSubscription",
        "function testFailedSendAmongWatchersDoesNotClaimSuccessOrDropWatches",
        "function testFailedDigestSendDoesNotClaimSiblingsOrDropWatch",
        "failNextForTests",
        "getTestOutbox",
        "secret plot",
        "rate_limit",
