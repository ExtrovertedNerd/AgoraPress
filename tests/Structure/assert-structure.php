...
$requiredPaths = [
    ...
    'ap-includes/class-ap-admin-menu.php',
    ...
    'ap-includes/class-ap-wxr-importer.php',
    'ap-includes/class-ap-phpbb-importer.php',
    'ap-admin/import.php',
    'ap-includes/class-ap-privacy.php',
    'ap-includes/class-ap-analytics.php',
    'ap-admin/analytics.php',
    'ap-admin/includes/class-ap-admin-analytics.php',
    ...
    'ap-includes/class-ap-rate-limit.php',
    ...
    'ap-includes/class-ap-object-cache.php',
    'ap-includes/object-cache-default.php',
    'ap-includes/class-ap-page-cache.php',
