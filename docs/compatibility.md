...
This is the **classic WordPress theme shim** guide for AgoraPress **`0.3.7-beta`** (schema `AP_DB_VERSION` **12**). High-priority differentiator: many **pre-block classic PHP themes** can be uploaded and run on AgoraPress with minimal changes.
