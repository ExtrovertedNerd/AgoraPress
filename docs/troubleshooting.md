...
This is the **symptom → check** guide for AgoraPress **`0.3.10-beta`** (schema
...
These used to surprise operators. On **0.3.10-beta** the current behaviour
is:
...
If comments still do not save on 0.3.10-beta, check the blog module, the
