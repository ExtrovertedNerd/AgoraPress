...
product at `AP_VERSION` **0.3.7-beta** · schema `AP_DB_VERSION` **12**.
...
5. Describe the system **as built** at 0.3.7-beta / schema 12. Do **not
...
1. Confirm the site is **0.3.7-beta** / schema **12** when the question is
