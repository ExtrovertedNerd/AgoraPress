...
product at `AP_VERSION` **0.3.11-beta** · schema `AP_DB_VERSION` **13**.
...
5. Describe the system **as built** at 0.3.11-beta / schema 13. Do **not
...
1. Confirm the site is **0.3.11-beta** / schema **13** when the question is
