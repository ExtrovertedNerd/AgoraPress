...
**Version under review:** `AP_VERSION` **`0.3.11-beta`** · schema `AP_DB_VERSION` **13**
...
- Versioned migrations (`AP_DB_VERSION` = 13), Site Health, Update Core screen, **Tools → Analytics**, forum likes (v11), topic type enum (v12), topic subscriptions (v13 — [schema.md](schema.md), [forums.md](forums.md)).
