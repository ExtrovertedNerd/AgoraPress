...
This is the **core update guide** for AgoraPress **`0.3.8-beta`** (schema
...
{
  "version": "0.3.8-beta",
  "download_url": "https://agorapress.extrovertednerd.com/download/AgoraPress-0.3.8-beta.zip",
...
php bin/package-release.php --version=0.3.8-beta
