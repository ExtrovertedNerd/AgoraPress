...
This is the **schema guide** for AgoraPress **`0.3.11-beta`** (schema `AP_DB_VERSION` **13**). It describes tables, numbered migrations, the configurable prefix (default **`ap_`**), and multi-driver notes **as built**.
...
**Target schema version:** `AP_DB_VERSION` in `ap-includes/version.php` (currently **13**, AgoraPress `0.3.11-beta`)
