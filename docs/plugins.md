...
This is the **plugin integrator guide** for AgoraPress **`0.3.10-beta`** (schema `AP_DB_VERSION` **13**). It describes headers, must-use plugins, shortcodes, the Settings API, ACP pages (`ap_register_admin_page`), and the zip installer **as built**.
